...
export default {
      ...
      form: this.$inertia.form(
        {
          ...
          title: "",
          slug: "",
          description: this.edit ? this.project.data.description : "",
          image: "",
        },
        {
  ...
  methods: {
    saveProject() {
      this.edit
        ? this.form.post(route("projects.update", { id: this.project.data.id }))
  ...
  mounted() {
    if (this.edit) {
      this.form.category_id = this.project.data.category_id;
      this.form.title = this.project.data.title;
      this.form.slug = this.project.data.slug;
    }

    this.imageUrl = this.project.data.image_url;
  },
};
</script>
