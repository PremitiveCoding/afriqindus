...
export default {
      ...
      form: this.$inertia.form(
        {
          ...
          title: "",
          slug: "",
          description: this.edit ? this.service.data.description : "",
          image: "",
        },
        {
  ...
  mounted() {
    if (this.edit) {
      this.form.category_id = this.service.data.category_id;
      this.form.title = this.service.data.title;
      this.form.slug = this.service.data.slug;
    }
